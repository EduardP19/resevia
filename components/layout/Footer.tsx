    ...
    <footer className="bg-[#271549] pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/blog" className="text-white/60 hover:text-brand-gold text-sm transition-colors">
                  Blog
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/privacy-policy" className="text-white/60 hover:text-brand-gold text-sm transition-colors">
                  Privacy Policy
                </Link>
              </li>
              <li>
                <Link href="/terms" className="text-white/60 hover:text-brand-gold text-sm transition-colors">
                  Terms of Service
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-white/10 pt-8 mt-8 text-center text-sm text-white/40">
          <p>© 2026 Resevia, a trading name of EMAGF LTD, registered in England &amp; Wales, company no. 12437054. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
